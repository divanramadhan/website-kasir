...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      <img class="mb-4" src="assets/images/logo pti-icon.png" alt="" width="243" height="213">
      ...
      <p class="mt-3 mb-3 text-black"> Belum Punya Akun? <a href="registrasi.php" class="text-black">
     Registrasi</a></p>
    </form>
